package com.moisesmiiranda.desafiotecnico.domain;
...
public class Input implements Serializable {
	...
	public Input(Integer logic, String serial, String model, Integer sam, String ptid, Integer plat, String version,
	...
	public String toString() {
		return "Input [logic=" + logic + ", serial=" + serial + ", model=" + model + ", sam=" + sam + ", ptid=" + ptid
